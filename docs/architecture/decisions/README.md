...
| `0004-e-subduction-crust-consumption.md` | Accepted | Defines Prototype E as explicit subduction consumption of persistent D ocean crust while preserving C ownership/boundary authority. |
